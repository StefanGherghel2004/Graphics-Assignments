...
void Lab1::Init()
{
    ...
    // no matter how many times we want to draw this mesh.
    {
        ...
        Mesh* plantuta = new Mesh("bambus");
        plantuta->LoadMesh(PATH_JOIN(window->props.selfDir, RESOURCE_PATH::MODELS, "vegetation/bamboo"), "bamboo.obj");
        meshes[plantuta->GetMeshID()] = plantuta;
...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes[meshNames[index]], glm::vec3(-1, 0.5f, 0));
    ...
    // randarea palmierilor
    for (int i = 0; i < 20; i++) {
        RenderMesh(meshes["bambus"], glm::vec3(-40 + 4 * i, 3, -40 + 4 * i));
    }
}

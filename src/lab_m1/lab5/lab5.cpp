...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    if (perspective) {
        ...
        projectionMatrix = glm::ortho(ortoleft, ortoright, ortobottom, ortotop, 0.01f, 200.0f);
    }
...

    {
        ...
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-6, 0.5f, 0));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(40.0f), glm::vec3(0, 1, 0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(2, 2, 3));
...
void Lab5::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        // am adaugat si functionalitatea asta ca sa testez
    ...
    if (window->KeyHold(GLFW_KEY_3)) {
        // increase field of view
        ortobottom -= deltaTime * ortoSpeed;
        ortotop += deltaTime * ortoSpeed;
    }
    ...
    if (window->KeyHold(GLFW_KEY_5)) {
        // increase field of view
        ortoleft -= deltaTime * ortoSpeed;
        ortoright += deltaTime * ortoSpeed;
    }

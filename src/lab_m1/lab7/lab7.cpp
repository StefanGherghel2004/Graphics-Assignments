...
void Lab7::Init()
{
    ...
    {
        lightPosition = glm::vec3(30, 1, 30);
...
void Lab7::Update(float deltaTimeSeconds)
{
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0, 0.3, 1));
    }
    ...
    lightPosition.x = 3 *  sinf(radians);
    lightPosition.z = 3 * cosf(radians);
